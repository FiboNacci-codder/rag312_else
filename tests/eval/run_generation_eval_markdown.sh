...
# Uso: ./run_generation_eval_markdown.sh [n_muestra]   (default: todas las preguntas)
set -euo pipefail
...
python eval_generation.py --golden golden_set_md_final.json --out resultados_generation_md.json "${MUESTRA_ARGS[@]}"
